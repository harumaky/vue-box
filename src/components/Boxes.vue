<template>
  <v-container>
    <h2 class="text-h2 mb-5">Boxes - Vuetify</h2>

    <v-row v-masonry>
      <box-card
        title="Border Radius"
        url="https://vuetifyjs.com/ja/styles/border-radius/"
      >
        <v-row>
          <v-col
      ...
      <box-card
        title="Typography"
        url="https://vuetifyjs.com/ja/styles/text-and-typography/"
        hasmemo
      >
        <template #memo>
          <p>.text-{}で設定</p>
        ...
        <v-item-group mandatory>
          <v-sheet class="overflow-y-auto" max-height="600" tile>
            <v-item
              v-for="[c, text, size, weight, spacing, margin] in typoClasses"
              :key="c"
            >
